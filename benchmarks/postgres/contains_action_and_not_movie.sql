...
\echo 'short with idx'
\o contains_action_and_not_movie_idx_short.txt
...
\o contains_action_and_not_movie_idx_medium.txt
EXPLAIN (ANALYZE, TIMING OFF)
...
\echo 'long with idx'
\o contains_action_and_not_movie_idx_long.txt
EXPLAIN (ANALYZE, TIMING OFF)
...
-- without idx
\echo 'short no idx'
\o contains_action_and_not_movie_no_idx_short.txt
EXPLAIN (ANALYZE, TIMING OFF)
...
\echo 'medium no idx'
\o contains_action_and_not_movie_no_idx_medium.txt
EXPLAIN (ANALYZE, TIMING OFF)
...
\echo 'long no idx'
\o contains_action_and_not_movie_no_idx_long.txt
EXPLAIN (ANALYZE, TIMING OFF)
